...
There are two kind of melds; sets and runs.
A set consists of 3 or more cards of the same rank, irrespective of suit.
A run consists of 4 or more cards of the same suit, in consecutive order. An ace can count as low or high, but not both. So A 2 3 4 and J Q K A are both valid runs, but Q K A 2 is not valid.
...
1. 2 Sets (6 cards)
2. 1 Set, 1 Run (7 cards)
3. 2 Runs (8 cards)
4. 3 Sets (9 cards)
5. 2 Sets, 1 Run (10 cards)
6. 2 Runs, 1 Set (11 cards)
7. 3 Runs and No Discard (explained later)
...
### Taking the Discard Out of Turn (the "I Call")
...
Each player may only call a maximum of 3 times during each round. An easy way to identify how many times a player has called is for the player to count the cards in their hand.
11 cards - no calls.
13 cards - 1 call.
15 cards - 2 calls.
17 cards - 3 calls. The player may not call again.
...
Meld: 8♢, 9♢, Joker, Jack♢ (<span style="font-size: 48px;">🃈, 🃉, 🃏, 🃋</span>)
...
Meld: Joker, 9♢, 10♢, Jack♢ (<span style="font-size: 48px;">🃏, 🃉, 🃊, 🃋</span>)
...
Meld: 9♢, 10♢, Jack♢, Joker (<span style="font-size: 48px;">🃉, 🃊, 🃋, 🃏</span>)
...
In the final round, you must meld all your cards at once.
As you have melded all your cards, there is no discard - play ends immediately after the meld.
